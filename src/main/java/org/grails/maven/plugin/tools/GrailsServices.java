...
public interface GrailsServices {
   ...
   * @param grailsProjectDescriptor The Grails project descriptor
   * @param mtgGroupId              The groupId of the plugin
   * @param mtgArtifactId           The artifactId of the plugin
   * @param grailsVersion           The grails version used by the application
   ...
   *
   * @param projectDir              The Grails project directory.
   * @param grailsProjectDescriptor The descriptor to write.
